    ...
    void buscarCliente(ActionEvent event) {
    	...
    	if(!idString.equals(""))
    	{
    		...
    		if (clientef != null)
    		{
    			...
    			labelID.setText(clientef.getId()+"");
    			tx_nome_cliente.setText(clientef.getNome());
    			tx_email_cliente.setText(clientef.getEmail());
    			tx_telefone_cliente.setText(clientef.getTelefone()+"");
    			tx_cpf_cliente.setText(clientef.getCpf()+"");
    			tx_cep_cliente.setText(clientef.getCep());
    		}
    	}
